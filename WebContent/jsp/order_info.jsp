...
<html>
	...
	<body>
		...
		<div class="container">
			...
			<div>
				<hr/>
				<form action="${pageContext.request.contextPath }/payOrder.order" class="form-horizontal" style="margin-top:5px;margin-left:150px;" id="orderForm" method="post">
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" class="form-control" id="telephone" placeholder="请输入联系方式">
						</div>
					</div>
