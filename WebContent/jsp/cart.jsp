		...
		<div class="container">
			...
			<c:if test="${not (empty cart || empty cart.cartItems) }">
						...
						<table class="table table-bordered">
							<tbody>
								...
								<tr class="active">
									...
									<td>
										<a href='${pageContext.request.contextPath }/removeCart.cart?pid=${ cartItem.product.pid}' class="delete">删除</a>
									</td>
								</tr>
								</c:forEach>
							</tbody>
				...
				<div style="text-align:right;margin-top:10px;margin-bottom:10px;">
					<a href="${pageContext.request.contextPath }/clearCart.cart" id="clear" class="clear">清空购物车</a>
					<a href="${pageContext.request.contextPath }/saveOrder.order">
